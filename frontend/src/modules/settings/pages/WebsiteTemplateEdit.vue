<template>
  <div class="website-template-editor">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
        <h4>Edit Website Template</h4>
        <p class="text-muted">Edit comprehensive template for marketing trips</p>
      </div>
      <div class="d-flex">
...
const loadTemplate = async () => {
  try {
    loading.value = true
    const response = await http.get(`/api/marketing/templates/${templateId}/`)
    ...
    successMessage.value = 'Failed to load template. Please try again.'
...
const saveTemplate = async () => {
  try {
    ...
    await http.put(`/api/marketing/templates/${templateId}/`, templateData)
    ...
    successMessage.value = 'Failed to update template. Please try again.'
    showSuccessModal.value = true
  } finally {
    saving.value = false
  }
